...
<body>
    ...
    <div class="counter"><span style="font-size:150px;">{working_days:,}</span> 日  
    <img src="cleanroom_jikken.png" alt="安全盾" style="width:50px; vertical-align: middle; margin-left: 5px;"></div>'
    <div class="date-box">
